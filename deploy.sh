#!/bin/bash
# ============================================
#   亚马逊赛训效率工具箱 - 云服务器一键部署脚本
#   在服务器终端粘贴执行即可
# ============================================
set -e
echo "============================================"
echo "  亚马逊赛训效率工具箱 - 一键部署"
echo "============================================"
...
echo "  scp -r ./backend/* root@8.130.113.104:/opt/amazon-toolbox/backend/"
echo ""
...
echo "  部署完成！"
echo "============================================"
echo "  后端地址: http://8.130.113.104:8000"
echo "  API文档:  http://8.130.113.104:8000/docs"
echo "  健康检查: http://8.130.113.104:8000/api/health"
echo ""
echo "  管理命令:"

...
<style scoped>
.batch-workspace{height:100%;min-height:0}.batch-setup{width:min(1060px,100%);margin:0 auto 30px;display:grid;border:1px solid var(--color-border);border-radius:18px;background:var(--color-surface);box-shadow:var(--shadow-medium);overflow:hidden}.setup-header{display:flex;justify-content:space-between;align-items:flex-start;gap:20px;padding:28px 30px;border-bottom:1px solid var(--color-border);background:linear-gradient(135deg,#fcfcfd,#f8f7f4)}.setup-header>div:first-child>span{font-size:10px;font-weight:800;letter-spacing:.13em;color:var(--color-accent)}.setup-header h1{margin:7px 0 0;font-size:27px;letter-spacing:-.04em;color:var(--color-text)}.setup-header p{margin:8px 0 0;color:var(--color-text-secondary);font-size:13px}.privacy-mark{display:flex;align-items:center;gap:7px;padding:7px 10px;border-radius:9px;color:var(--color-success);background:#edf8f4;font-size:11px;font-weight:700;white-space:nowrap}.setup-section{display:grid;grid-template-columns:38px 190px 1fr;gap:15px;padding:24px 30px;border-bottom:1px solid var(--color-border)}.setup-section.disabled{opacity:.55}.section-number{font:700 11px/1 var(--font-mono,monospace);color:var(--color-accent);padding-top:4px}.section-copy{display:grid;align-content:start;gap:5px}.section-copy strong{font-size:13px;color:var(--color-text)}.section-copy span{font-size:11px;line-height:1.55;color:var(--color-text-tertiary)}.business-tools{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.business-tools button{min-height:76px;display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:12px;padding:13px;text-align:left;border:1px solid var(--color-border);border-radius:13px;background:var(--color-surface);cursor:pointer;transition:border var(--motion-fast),box-shadow var(--motion-fast),transform var(--motion-press)}.business-tools button:hover{border-color:var(--color-border-strong);box-shadow:var(--shadow-low)}.business-tools button:active{transform:scale(.99)}.business-tools button.selected{border-color:rgba(45,95,202,.45);background:var(--color-primary-soft)}.tool-icon{width:38px;height:38px;display:grid;place-items:center;border-radius:11px;color:var(--color-primary);background:var(--color-primary-soft)}.business-tools button>span:nth-child(2){display:grid;gap:4px}.business-tools strong{font-size:12px;color:var(--color-text)}.business-tools small{font-size:10px;line-height:1.4;color:var(--color-text-tertiary)}.business-tools button>svg{color:var(--color-primary)}.no-tools{grid-column:1/-1;padding:24px;border:1px dashed var(--color-border);border-radius:12px;text-align:center;color:var(--color-text-secondary);font-size:12px}.import-zone{display:grid;gap:10px}.import-button{min-height:68px;display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:12px;padding:12px 15px;border:1px dashed var(--color-border-strong);border-radius:13px;background:var(--color-surface-soft);text-align:left;cursor:pointer}.import-button:disabled{cursor:not-allowed}.import-button>svg{color:var(--color-primary)}.import-button span{display:grid;gap:3px}.import-button strong{font-size:12px;color:var(--color-text)}.import-button small{font-size:10px;color:var(--color-text-tertiary)}.import-result{display:flex;gap:12px}.import-result span{display:flex;align-items:center;gap:5px;font-size:11px;font-weight:700}.valid{color:var(--color-success)}.invalid{color:var(--color-warning)}.preview-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.preview-list>div{display:flex;justify-content:space-between;padding:8px 10px;border-radius:8px;background:var(--color-surface-soft);font-size:10px;color:var(--color-text-secondary)}.preview-list small{color:var(--color-text-tertiary)}.preview-list .more-row{grid-column:1/-1;justify-content:center}.error-list{display:grid;gap:4px;padding:10px;border-radius:9px;color:var(--color-danger);background:#fff2f3;font-size:10px}.setup-footer{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:20px 30px;background:var(--color-surface-soft)}.setup-footer>div{display:grid;gap:4px}.setup-footer strong{font-size:12px;color:var(--color-text)}.setup-footer span{font-size:10px;color:var(--color-text-tertiary)}.setup-footer button{height:42px;display:flex;align-items:center;gap:8px;padding:0 18px;border:0;border-radius:11px;color:#fff;background:var(--color-primary);font-weight:700;cursor:pointer;box-shadow:0 8px 18px rgba(45,95,202,.18)}.setup-footer button:disabled{opacity:.45;cursor:not-allowed}
.has-batch{display:grid;grid-template-rows:auto minmax(0,1fr);gap:10px}.workspace-header{min-height:58px;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:18px;padding:0 15px;border:1px solid var(--color-border);border-radius:14px;background:var(--color-surface);box-shadow:var(--shadow-low)}.batch-identity{display:flex;align-items:center;gap:10px}.professional-badge{padding:5px 7px;border-radius:6px;color:var(--color-accent);background:#f1eadf;font-size:8px;font-weight:800;letter-spacing:.1em}.batch-identity div{display:grid;gap:2px}.batch-identity strong{font-size:12px;color:var(--color-text)}.batch-identity small{font-size:9px;color:var(--color-text-tertiary)}.batch-counts{display:flex;align-items:center}.batch-counts>span{min-width:84px;display:grid;gap:2px;padding:0 16px;border-left:1px solid var(--color-border);text-align:center}.batch-counts>span:first-child{border:0}.batch-counts small{font-size:9px;color:var(--color-text-tertiary)}.batch-counts strong{font-size:15px;color:var(--color-text);font-variant-numeric:tabular-nums}.batch-counts .attention strong{color:var(--color-warning)}.header-actions{display:flex;justify-content:flex-end;align-items:center;gap:12px}.sync-state{font-size:9px;color:var(--color-success)}.sync-state.is-offline{color:var(--color-warning)}.header-actions button{height:32px;display:flex;align-items:center;gap:6px;padding:0 10px;border:1px solid var(--color-border);border-radius:8px;color:var(--color-text-secondary);background:transparent;font-size:10px;cursor:pointer}.workspace-grid{min-height:0;display:grid;grid-template-columns:244px minmax(0,1fr) 286px;gap:10px}.account-queue,.action-panel,.browser-shell{min-height:0;border:1px solid var(--color-border);border-radius:14px;background:var(--color-surface);box-shadow:var(--shadow-low);overflow:hidden}.account-queue{display:grid;grid-template-rows:auto 1fr}.account-queue>header,.action-panel>header{min-height:58px;display:flex;align-items:center;justify-content:space-between;padding:0 14px;border-bottom:1px solid var(--color-border)}.account-queue header div,.action-panel header div{display:grid;gap:3px}.account-queue header strong,.action-panel header strong{font-size:12px;color:var(--color-text)}.account-queue header small,.action-panel header span{font-size:9px;color:var(--color-text-tertiary)}.queue-list{min-height:0;padding:8px;display:flex;flex-direction:column;gap:4px;overflow-y:auto}.queue-item{width:100%;min-height:52px;display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:9px;padding:7px 9px;border:1px solid transparent;border-radius:10px;background:transparent;text-align:left;cursor:pointer;transition:background var(--motion-fast),border var(--motion-fast)}.queue-item:hover{background:var(--color-surface-soft)}.queue-item.selected{border-color:rgba(45,95,202,.2);background:var(--color-primary-soft)}.queue-state{width:28px;height:28px;display:grid;place-items:center;border-radius:9px;color:var(--color-text-tertiary);background:var(--color-surface-soft)}.queue-state>span{width:7px;height:7px;border-radius:50%;background:var(--color-border-strong)}.queue-item.is-running .queue-state{color:var(--color-primary);background:var(--color-primary-soft)}.queue-item.is-waiting_user .queue-state{color:var(--color-warning);background:#fff0d2;animation:attention-pulse 700ms ease 2}.queue-item.is-failed .queue-state{color:var(--color-danger);background:#fff0f1}.queue-item.is-completed .queue-state{color:var(--color-success);background:#eaf8f2}.queue-copy{display:grid;gap:3px;min-width:0}.queue-copy strong{overflow:hidden;text-overflow:ellipsis;font-size:11px;color:var(--color-text)}.queue-copy small{font-size:9px;color:var(--color-text-tertiary)}.queue-item>svg{color:var(--color-text-tertiary)}.browser-stage{min-width:0;min-height:0}.browser-shell{height:100%;display:grid;grid-template-rows:42px minmax(0,1fr)}.browser-toolbar{display:flex;align-items:center;gap:8px;padding:0 12px;border-bottom:1px solid var(--color-border);color:var(--color-text-tertiary);font-size:10px}.browser-toolbar>span:nth-of-type(2){min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.browser-toolbar small{padding:4px 7px;border-radius:6px;background:var(--color-surface-soft);color:var(--color-text-secondary)}.traffic{display:flex;gap:4px;margin-right:3px}.traffic i{width:6px;height:6px;border-radius:50%;background:#d8dce3}.browser-viewport{position:relative;min-height:0;background:#f2f4f7}.batch-webview{position:absolute;inset:0;width:100%;height:100%;border:0;background:#fff}.browser-placeholder,.desktop-required{position:absolute;inset:0;display:grid;place-content:center;justify-items:center;gap:10px;text-align:center;color:var(--color-text-tertiary)}.browser-placeholder strong,.desktop-required strong{color:var(--color-text)}.browser-placeholder span,.desktop-required span{font-size:11px}.automation-shield{position:absolute;left:50%;bottom:16px;z-index:3;transform:translateX(-50%);display:flex;align-items:center;gap:7px;padding:8px 11px;border:1px solid rgba(45,95,202,.18);border-radius:99px;color:var(--color-primary);background:rgba(252,252,253,.94);box-shadow:var(--shadow-medium);font-size:9px;pointer-events:none}.action-panel{padding-bottom:14px}.action-panel>header{margin-bottom:14px}.mobile-close{display:none;border:0;background:transparent;color:var(--color-text-secondary)}.status-hero{margin:0 14px;padding:17px;border-radius:13px;background:var(--color-surface-soft);display:grid;justify-items:start;gap:7px}.status-symbol{width:38px;height:38px;display:grid;place-items:center;border-radius:12px;color:var(--color-text-secondary);background:#fff}.status-hero>span{font-size:13px;font-weight:800;color:var(--color-text)}.status-hero p{min-height:34px;margin:0;font-size:10px;line-height:1.6;color:var(--color-text-secondary)}.status-hero.is-running{background:var(--color-primary-soft)}.status-hero.is-running .status-symbol{color:var(--color-primary)}.status-hero.is-waiting_user{background:#fff8eb}.status-hero.is-waiting_user .status-symbol{color:var(--color-warning)}.status-hero.is-completed{background:#edf8f4}.status-hero.is-completed .status-symbol{color:var(--color-success)}.status-hero.is-failed{background:#fff2f3}.status-hero.is-failed .status-symbol{color:var(--color-danger)}.business-stage{margin:18px 14px;display:grid;gap:8px}.business-stage>span{font-size:9px;color:var(--color-text-tertiary)}.business-stage>div{display:grid;grid-template-columns:repeat(4,1fr);gap:4px}.business-stage i{height:3px;border-radius:9px;background:var(--color-border)}.business-stage i.done{background:var(--color-success)}.business-stage i.active{background:var(--color-primary)}.business-stage small{font-size:8px;color:var(--color-text-tertiary);word-spacing:7px}.primary-action{width:calc(100% - 28px);height:38px;margin:0 14px;border:0;border-radius:10px;color:#fff;background:var(--color-primary);font-size:11px;font-weight:700;cursor:pointer}.primary-action.warning{background:var(--color-warning)}.security-note{margin:14px;display:flex;align-items:flex-start;gap:7px;padding:11px;border-radius:10px;color:var(--color-success);background:#edf8f4}.security-note span{font-size:9px;line-height:1.55}.mobile-toolbar,.mobile-overlay{display:none}.spin{animation:spin 900ms linear infinite}@keyframes spin{to{transform:rotate(360deg)}}@keyframes attention-pulse{50%{transform:scale(1.06);box-shadow:0 0 0 5px rgba(183,121,31,.09)}}
@media(max-width:1279px){.workspace-grid{grid-template-columns:230px minmax(0,1fr)}.action-panel{position:fixed;top:calc(var(--header-height) + 10px);right:10px;bottom:10px;z-index:1001;width:min(310px,88vw);transform:translateX(calc(100% + 20px));transition:transform var(--motion-normal) var(--ease-emphasized);box-shadow:var(--shadow-overlay)}.action-panel.mobile-open{transform:translateX(0)}.mobile-toolbar{height:38px;display:flex;align-items:center;justify-content:space-between;padding:0 8px}.mobile-toolbar button{display:flex;align-items:center;gap:5px;border:0;background:transparent;color:var(--color-text-secondary);font-size:9px}.mobile-toolbar span{font-size:10px;color:var(--color-text)}.browser-stage{display:grid;grid-template-rows:auto minmax(0,1fr)}.mobile-close{display:grid}.mobile-overlay{display:block;position:fixed;inset:0;z-index:1000;background:var(--color-overlay)}}
@media(max-width:899px){.workspace-header{grid-template-columns:1fr auto}.batch-counts{display:none}.sync-state{display:none}.workspace-grid{display:block;position:relative}.browser-stage{height:100%}.account-queue{position:fixed;top:calc(var(--header-height) + 10px);left:10px;bottom:10px;z-index:1001;width:min(280px,88vw);transform:translateX(calc(-100% - 20px));transition:transform var(--motion-normal) var(--ease-emphasized);box-shadow:var(--shadow-overlay)}.account-queue.mobile-open{transform:translateX(0)}.setup-header,.setup-footer{display:grid}.setup-section{grid-template-columns:32px 1fr;padding:20px}.setup-section>.section-copy{grid-column:2}.setup-section>.business-tools,.setup-section>.import-zone{grid-column:1/-1}.business-tools,.preview-list{grid-template-columns:1fr}.privacy-mark{width:max-content}.setup-footer button{width:100%;justify-content:center}}
.error-list button{width:max-content;margin-top:4px;padding:4px 7px;border:1px solid rgba(195,61,73,.18);border-radius:6px;color:var(--color-danger);background:#fff;font-size:9px;cursor:pointer}

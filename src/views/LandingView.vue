  ...
  <main ref="landingRoot" class="landing" :class="{ 'motion-ready': motionReady, 'motion-paused': motionPaused }" data-route-focus>
    ...
    <section id="capabilities" class="section capabilities-section">
      <div class="landing-container">
        ...
        <div class="tool-grid">
          <article class="tool-card tool-card-primary" data-reveal><div class="tool-card-top"><span class="tool-icon"><FileSpreadsheet :size="25" :stroke-width="1.5" aria-hidden="true" /></span><span class="availability">支持演示</span></div><p class="tool-purpose">按规则填写模板</p><h3>物流模板标准版</h3><p class="tool-description">输入配送国家、包裹重量与尺寸，串起运费计算与模板填写流程。</p><div class="tool-sample" aria-hidden="true"><div class="sample-label">一份资料，连接后续操作</div><div class="input-example"><span>配送国家</span><span>重量</span><span>尺寸</span></div><div class="sample-output"><CornerDownRight :size="16" /><span>物流模板填写</span></div></div><RouterLink :to="anchor('workflow')" class="text-link">了解使用方式 <ArrowUpRight :size="16" aria-hidden="true" /></RouterLink></article>

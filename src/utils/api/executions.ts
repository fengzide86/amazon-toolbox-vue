...
export const getExecutionsPage = (params: ApiQueryParams = {}): Promise<components['schemas']['ExecutionPageResponse']> =>
  api.get('/api/executions', params, { cache: false, responseMode: 'raw' })

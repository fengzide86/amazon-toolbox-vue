      ...
      <div class="header-left">
        ...
        <router-link :to="homePath" class="logo-link">
          ...
          <div class="header-title">
            <h1>{{ isAdmin ? '运营控制中心' : isBusiness ? '专业工作台' : '自动化工具箱' }}</h1>
...
import { Crown, Menu, ShieldCheck, Zap } from '@lucide/vue'

...
nav{display:grid;gap:5px;padding:20px 12px;flex:1}nav a{position:relative;min-height:42px;display:flex;align-items:center;gap:11px;padding:0 13px;border-radius:10px;color:var(--color-text-secondary);font-size:var(--type-control);font-weight:600;text-decoration:none;transition:background var(--motion-fast),color var(--motion-fast)}nav a:hover{color:var(--color-text);background:#f2f4f7}nav a.is-active{color:var(--color-primary);background:var(--color-primary-soft)}nav a.is-active:before{content:'';position:absolute;left:0;top:10px;bottom:10px;width:3px;border-radius:3px;background:var(--color-primary)}

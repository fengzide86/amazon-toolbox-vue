...
.business-brand{height:var(--shell-header-height,88px);display:flex;align-items:center;gap:11px;padding:0 20px;border-bottom:1px solid var(--color-border)}
.brand-mark{width:32px;height:32px;display:grid;place-items:center;border-radius:10px;color:#fff;background:var(--color-primary);box-shadow:0 7px 17px rgba(45,95,202,.18)}
.business-brand div:last-child{display:grid;gap:1px;min-width:0}.business-brand strong{font-size:var(--type-control);color:var(--color-text)}.business-brand span{font-size:var(--type-micro);letter-spacing:.08em;color:var(--color-primary)}

...
.business-brand div:last-child{display:grid;gap:1px;min-width:0}.business-brand strong{font-size:13px;color:var(--color-text)}.business-brand span{font-size:var(--type-micro);letter-spacing:.08em;color:var(--color-primary)}

@echo off
echo ============================================
echo   Amazon Toolbox - One Click Build
echo ============================================
echo.
...
if exist "release" (
    ...
    if exist "release" (
        echo Warning: release directory cannot be fully deleted, may be locked by antivirus
        echo Please manually delete the release directory and retry
        pause
        exit /b 1
    )
